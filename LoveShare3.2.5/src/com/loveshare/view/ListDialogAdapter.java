...
public class ListDialogAdapter extends BaseAdapter {
	...
	ListDialogAdapter(Context context, ArrayList<HashMap<String, Object>> arrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView = LayoutInflater.from(context).inflate(R.layout.view_dialog_listcell,
				null);
		TextView view_list_tv = (TextView) convertView.findViewById(R.id.textView);
